                                                                    ...
                                                                    <div class="cg-main">
                                                                        <div class="item util-clearfix">
                                                                                <h3  class="big-title anchor1 anchor-agricuture">
                                                                                    ...
                                                                                    <i class="cg-icon"></i>
                                                                                  <a style={{color:"#009345"}} href={"/productList/"+item.category.id}>{item.category.category_name}</a>
                                                                                </h3>
                                                                                        ...
                                                                                        item.subcategories.length>0?
                                                                                         item.subcategories.map((item2,key2)=>{
                                                                                            ...
                                                                                            <React.Fragment>
                                                                                                <div class="sub-item">
                                                                                            <h4 class="sub-title">
                                                                                            <a href={"/productList/"+item2.category.id} style={{color: "#ec1c24",textDecoration: "none"}}>
                                                                                            ...
                                                                                            <ul class="sub-item-cont util-clearfix">
                                                                                                    {
                                                                                                        ...
                                                                                                        :<p style={{color:"#ec1c24"}}>No More Sub-Categories</p> 
                                                                                                    }
                                                                                            </ul>
                                                                                        </div>
                                                                                    </div>
